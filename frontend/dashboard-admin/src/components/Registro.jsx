...
const Registro = ({ onRegistrado, setMensaje, setTipo }) => {
  ...
  const handleRegistro = async (e) => {
    ...
    try {
      const res = await fetch("https://restaurante-web-app-production.up.railway.app/api/auth/registrar", {
        method: "POST",
      ...
      if (res.ok) {
        const loginRes = await fetch("https://restaurante-web-app-production.up.railway.app/api/auth/iniciar-sesion", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
